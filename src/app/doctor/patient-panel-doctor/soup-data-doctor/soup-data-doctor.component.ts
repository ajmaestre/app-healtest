...
@Component({
  selector: 'app-soup-data-doctor',
  standalone: true,
  imports: [
    NgIf,
    NgFor,
  ],
  templateUrl: './soup-data-doctor.component.html',
  styleUrl: './soup-data-doctor.component.css'
})
export class SoupDataDoctorComponent implements OnInit, OnDestroy{
  ...
  ngOnInit(): void {
    this.createListCell();
    this.createList();
    this.patientService.dataSoupPanelSent$.subscribe((dataSended) => {
