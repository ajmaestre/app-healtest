...
export class AdminComponent {
  ...
  loadModalGroup: string = 'div-form-add hide';
  loadGroupAnim: string = 'page-add';
  ...
  loadPageListGroup(styles: {page: string, pageAdd: string}) {
    this.loadModalGroup = styles.page;
    this.loadGroupAnim = styles.pageAdd;
  }
